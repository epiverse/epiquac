...
core.data.dict <- box_read() %>% filter(Category == "Core")


# reading incident data dictionary
incident.data.dict <- box_read() %>% 
...
bcrpp.core.correction.rules <- box_read()
...
bcrpp.core.warning.rules <- box_read()
...
bcrpp.incident.correction.rules <- box_read()
...
bcrpp.incident.warning.rules <- box_read()
